...
export class GameService {
  ...
  private normalBall(room: Room) {
    ...
    if (scorer >= 0) {
      ...
      console.log("score 0: " + room.players[0].socket!.data.user.name + ": " + room.players[0].stats.score);
      console.log("score 1: " + room.players[1].socket!.data.user.name + ": " + room.players[1].stats.score);
